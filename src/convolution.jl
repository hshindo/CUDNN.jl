...
function convolution!{T}(x::CuArray{T}, w::CuArray{T}, desc::ConvolutionDesc, y::CuArray{T};
  alpha=1.0, beta=0.0)
  ...
  cudnnConvolutionForward(h, T[alpha], xdesc, x, wdesc, w, desc, algo, workspace, worksize, T[beta], ydesc, y)
  y
end
